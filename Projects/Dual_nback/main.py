...
import pygame, sys, datetime, time, secrets, json
import os
...
def show_text(screen, text, coor, color, size, fontname):
    font = pygame.font.Font(fontname, size)
...
text_score_helper = f"Increase the number of questions to {current_nback * 3}\nto earn a '{current_nback} back' point!"
...
while run:
    ...
    # score screen
        ...
        show_text(screen,f"The number of questions : {the_number_of_questions}", (screenwidth / 2, 260), color["white"], 30, "F25_Bank_Printer.otf")
    ...
    # game settings
        ...
        show_text(screen, texts_game_settings[1], (screenwidth / 5 - 15, 230), color["white"], 40, "sketched.ttf")
        show_text(screen, texts_game_settings[2], (screenwidth / 3 + 25, 340), color["white"], 40, "sketched.ttf")
        show_text(screen, texts_game_settings[3],(screenwidth / 3 + 25, 470), color["white"], 40, "sketched.ttf")
        show_text(screen,texts_game_settings[4], (screenwidth / 3 - 28, 590), color["white"], 40, "sketched.ttf")
        show_text(screen,texts_game_settings[5], (screenwidth / 3 - 7, 710), color["white"], 40, "sketched.ttf")
    ...
    # scoreboard
        ...
        if level_system["n9_exp"] >= 100:
            pygame.draw.rect(screen, color["black"], (200, 355, 560, 50), border_radius = 2)
            starimg = pygame.image.load("img/star.png")
            ...
            screen.blit(starimg, starimg_rect2)
            screen.blit(starimg, starimg_rect3)
            show_text(screen, "God", (screenwidth / 2, 470), color["white"], 80, "cleanfont.ttf")
        elif level_system["n8_exp"] >= 100:
            pygame.draw.rect(screen, color["black"], (200, 355, 560, 50), border_radius = 2)
            starimg = pygame.image.load("img/star.png")
            ...
            screen.blit(starimg, starimg_rect)
            screen.blit(starimg, starimg_rect2)
            show_text(screen,"Grand Master", (screenwidth / 2, 470), color["white"], 80, "cleanfont.ttf")
        elif level_system["n7_exp"] >= 100:
            pygame.draw.rect(screen, color["black"], (200, 355, 560, 50), border_radius = 2)
            starimg = pygame.image.load("img/star.png")
            starimg_rect = starimg.get_rect(center = (screenwidth / 2, 380))
            screen.blit(starimg, starimg_rect)
            show_text(screen, "Master", (screenwidth / 2, 470), color["white"], 80, "cleanfont.ttf")
        elif (100 <= level_system["tries"] and level_system["n6_exp"] >= 30) or level_system["n6_exp"] >= 60:
            pygame.draw.rect(screen, color["black"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen, "black", (screenwidth / 2, 470), color["black"], 80, "cleanfont.ttf")
        elif (100 <= level_system["tries"] and level_system["n5_exp"] >= 25) or level_system["n5_exp"] >= 50:
            pygame.draw.rect(screen, color["red"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen, "red", (screenwidth / 2, 470), color["red"], 80, "cleanfont.ttf")
        elif (80 <= level_system["tries"] and level_system["n4_exp"] >= 20) or level_system["n4_exp"] >= 40:
            pygame.draw.rect(screen, color["brown"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen, "brown", (screenwidth / 2, 470), color["brown"], 80, "cleanfont.ttf")
        elif (50 <= level_system["tries"] and level_system["n3_exp"] >= 15) or level_system["n3_exp"] >= 30:
            pygame.draw.rect(screen, color["dark green"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen,"green", (screenwidth / 2, 470), color["dark green"], 80, "cleanfont.ttf")
        elif (50 <= level_system["tries"] and level_system["n2_exp"] >= 10) or level_system["n2_exp"] >= 20:
            pygame.draw.rect(screen, color["sky blue"], (200, 355, 560,50), border_radius = 2)
            show_text(screen, "blue", (screenwidth / 2, 470), color["sky blue"], 80, "cleanfont.ttf")
        elif (50 <= level_system["tries"] and level_system["n1_exp"] >= 5) or level_system["n1_exp"] >= 10:
            pygame.draw.rect(screen, color["yellow"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen, "yellow", (screenwidth / 2, 470), color["yellow"], 80, "cleanfont.ttf")
        elif 0 <= level_system["tries"] <= 49:
            pygame.draw.rect(screen, color["white"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen, "white", (screenwidth / 2, 470), color["white"], 80, "cleanfont.ttf")
        else:
            pygame.draw.rect(screen, color["white"], (200, 355, 560, 50), border_radius = 2)
            show_text(screen, "white", (screenwidth / 2, 470), color["white"], 80, "cleanfont.ttf")
